...
const Home = () => {
  ...
  const [skinIndex, setSkinIndex] = useState(() => getRandomIndex(SKIN_COLORS))
  const [eyeIndex, setEyeIndex] = useState(() => getRandomIndex(EYE_STYLES))
  const [mouthIndex, setMouthIndex] = useState(() => getRandomIndex(MOUTH_STYLES))
  const [hatIndex, setHatIndex] = useState(() => getRandomIndex(HAT_STYLES))
  ...
  // initial random state provided via lazy useState initializers
  ...
  return (
    <div className="bg-white flex flex-col items-center  ">
      ...
      <header className="mt-4 mb-2 z-10 text-center select-none">
        ...
        <p className="text-xs uppercase tracking-widest text-purple-400/60 mt-1 font-semibold">Premium Violet Edition</p>
      </header>
            ...
            <div className="bg-[#1b1538]/95 backdrop-blur-md border border-purple-500/20 shadow-2xl rounded-xl p-6 flex flex-col gap-4 relative z-10">
              ...
              <div className="bg-[#120e24]/80 border border-purple-500/20 rounded-xl p-4 flex items-center justify-between h-44 relative shadow-inner group">
                ...
                <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-2.5">
                  ...
                  <span className="text-[10px] font-bold text-purple-400/70 tracking-wider uppercase">Color</span>
                  <button
          ...
          <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-6 mt-4 py-8">
            ...
            <div className="bg-[#1b1538]/85 p-5 flex flex-col gap-4 shadow-lg hover:border-purple-500/25 transition-all">
              <div className="flex items-center gap-2.5 border-b border-purple-500/10 pb-3">
                ...
                <h2 className="text-xl font-bold tracking-wide text-white ">About</h2>
              </div>
              <div className="text-slate-300 text-sm leading-relaxed flex flex-col gap-3">
                <p>
                  <strong className="text-purple-400 font-semibold">skribbl.io</strong> is a free online multiplayer drawing and guessing pictionary
                  game.
                </p>
                <p>
                  A normal game consists of a few rounds, where every round a player has to draw their chosen word and others have to guess it to gain
                  points!
                </p>
                <p>The person with the most points at the end of the game will then be crowned as the winner! Have fun!</p>
              </div>
            </div>
            ...
            <div className="bg-[#1b1538]/85 p-5 flex flex-col gap-4 shadow-lg hover:border-purple-500/25 transition-all">
              <div className="flex items-center gap-2.5 border-b border-purple-500/10 pb-3">
                ...
                <h2 className="text-xl font-bold tracking-wide text-white">News</h2>
              </div>
              <div className="custom-scrollbar overflow-y-auto max-h-56 pr-2 text-slate-300 text-sm leading-relaxed flex flex-col gap-4">
                <div>
                  <div className="flex justify-between items-baseline mb-1 border-b border-purple-500/10 pb-1">
                    <span className="font-bold text-purple-300 text-sm uppercase tracking-wider">Fresh Paint</span>
                    <span className="text-[10px] text-purple-400/60 font-semibold">9th November 2022</span>
                  </div>
                  <p className="mb-2 text-slate-200 font-medium">Hello artists!</p>
                  <ul className="list-disc pl-4 space-y-1.5 text-sm text-slate-300">
                    <li>Redesign of the entire dashboard landing page</li>
                    <li>Responsive layout support for tablets and mobile screens</li>
                    <li>
                      <strong>Reworked Toolbar:</strong> Includes undo button, custom color selectors, click shortcut bindings, touch pressure
                      support, and hotkeys.
                    </li>
                    <li>
                      <strong>Moderation:</strong> Room owners can kick or ban users. Added votekick triggers, mute system, and reporting.
                    </li>
                    <li>Invite friends to public rooms with direct shareable URLs.</li>
                    <li>
                      <strong>Room Settings:</strong> Custom lobby player cap increased to 20, customizable word list lengths.
                    </li>
                  </ul>
                </div>
                <div>
                  <div className="flex justify-between items-baseline mb-1 border-b border-purple-500/10 pb-1">
                    <span className="font-bold text-purple-300 text-sm uppercase tracking-wider">Bug Fixes</span>
                    <span className="text-[10px] text-purple-400/60 font-semibold">24th September 2022</span>
                  </div>
                  <ul className="list-disc pl-4 space-y-1.5 text-sm text-slate-300">
                    <li>Fixed issue where pressing Enter key wouldn't send message data in lobby chat</li>
                    <li>Resolved websocket reconnect timeouts on bad connections</li>
                    <li>Optimized rendering for laggy brush strokes on Chrome</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#1b1538]/85 p-5 flex flex-col justify-between gap-4 shadow-lg hover:border-purple-500/25 transition-all">
              <div className="flex items-center gap-2.5 border-b border-purple-500/10 pb-3">
                ...
                <h2 className="text-xl font-bold tracking-wide text-white">How to play</h2>
              </div>
              ...
              <div className="flex-1 flex flex-col justify-center items-center text-center py-2 h-44">
                {carouselStep === 0 && (
                  <div className="flex flex-col items-center gap-2 animate-fadeIn">
                    ...
                    <div className="font-mono text-xl font-black tracking-wide text-rose-300 mt-1 select-none">CHOOSE A WORD!</div>
                    <div className="flex gap-2.5 my-2">
                      <span className="px-3 py-1.5 bg-[#120e24] border border-purple-500/25 text-xs rounded-lg font-bold opacity-60">Apple</span>
                      ...
                      <span className="px-3 py-1.5 bg-[#120e24] border border-purple-500/25 text-xs rounded-lg font-bold opacity-60">Water</span>
                    </div>
                    <p className="text-slate-300 text-sm max-w-xs mt-1 leading-relaxed">
                      When it's your turn, choose one of the three random secret words to draw!
                    </p>
                  </div>
                )}
                ...
                {carouselStep === 1 && (
                  <div className="flex flex-col items-center gap-2 animate-fadeIn">
                    ...
                    <div className="font-mono text-xl font-black tracking-wide text-indigo-300 mt-1 select-none">DRAW THE WORD!</div>
                    ...
                    <p className="text-slate-300 text-xs max-w-xs leading-relaxed">
                      Draw your chosen word to the other players. Don't write letters or words!
                    </p>
                  </div>
                )}
                ...
                {carouselStep === 2 && (
                  <div className="flex flex-col items-center gap-2 animate-fadeIn">
                    ...
                    <div className="font-mono text-xl font-black tracking-wide text-green-300 mt-1 select-none">GUESS IT FAST!</div>
                    <div className="flex flex-col gap-1 w-32 bg-[#120e24]/85 border border-purple-500/25 p-2 rounded-lg my-1.5 font-mono text-[9px] shadow-inner text-left">
                      ...
                      <div className="text-green-400 font-bold bg-green-500/10 px-1 rounded animate-pulse">User1 guessed the word!</div>
                    </div>
                    <p className="text-slate-300 text-xs max-w-xs leading-relaxed">
                      Try to guess what other players are drawing! Speed is key for high scores!
                    </p>
                  </div>
                )}
              </div>
                ...
                {[0, 1, 2].map((idx) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full cursor-pointer transition-all duration-300 ${
                      carouselStep === idx ? 'bg-purple-400 scale-125 shadow-[0_0_8px_rgba(168,85,247,0.6)]' : 'bg-purple-800 hover:bg-purple-600'
                    }`}
      ...
      <footer className="w-full bg-gray-900 p-4 md:p-2">
        ...
        <p className="text-[10px] text-purple-400/50 max-w-lg mx-auto leading-relaxed">
          The owner of this site is not responsible for any user generated content (drawings, messages, usernames) created during gameplay.
        </p>
      </footer>
    </div>
  )
